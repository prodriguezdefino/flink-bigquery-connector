...
public interface TwoPhaseCommittingStatefulSink<InputT>
        extends TwoPhaseCommittingSink<InputT, BigQueryCommitable>,
                StatefulSink<InputT, BigQueryWriterState> {

    @Override
    PrecommittingStatefulSinkWriter<InputT, BigQueryWriterState, BigQueryCommitable> createWriter(
            InitContext context) throws IOException;

    @Override
    PrecommittingStatefulSinkWriter<InputT, BigQueryWriterState, BigQueryCommitable> restoreWriter(
